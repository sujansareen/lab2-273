            ...
            <div className = 'Login' className="container">
                    ...
                    <div id="mainDiv" className="container">
                            ...
                            <div>
                                    ...
                                    <a href="/Login"><img src={image} width="180" height="60"/></a>
                                <br/><br/><br/><br/>
                                <h1 id = 'h1LoginandSignup'> Login And Sign Up Page  </h1><br/><br/><br/>
                            </div>
                            <div id="divLoginForm" className = "center">
                                <form onSubmit={this.handleLogin.bind(this)}>
                                    <div className="form-group">
                                        <input type="text" value={this.state.username} onChange={this.handleChange} className="form-control" id="txtUserName" placeholder="Enter your Username" ref="uname" name="username" required />
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        <h1> <Link to = "/signup" >Signup now</Link></h1>
                                    </div>
